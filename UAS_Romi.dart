...
class App04 extends StatelessWidget {
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        "Data": (context) => RomiDataTable(),
        "LupaPass": (context) => LupaPass(),
        "aritmatika": (context) => Aritmatika(),
      },
      title: 'FORM LOGIN',
      home: Scaffold(
        appBar: AppBar(
          title: Text('UAS ROMI - 6SIA11'),
        ),
        body: LoginPage(),
      ),
    );
...
class RomiDataTable extends StatefulWidget {
  _RomiDataTableState createState() =>
      _RomiDataTableState();
}

class _RomiDataTableState
    extends State<RomiDataTable> {
